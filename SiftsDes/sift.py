...
def process_image(imagename,resultname,params="--edge-thresh 10 --peak-thresh 5"):
    ...
    cmmd = str("C:\\Users\\wang\\Documents\\GitHub\\CBVideoSearch\\pythontest\\sift.exe "+imagename+" --output="+resultname+
                " "+params)
...
if __name__ == '__main__':
    imname = ('C:\\Users\\wang\\Documents\\GitHub\\CBVideoSearch\\pythontest\\IMG_2784.JPG')               #待处理图像路径
